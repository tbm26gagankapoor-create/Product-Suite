...
import { Calendar, Star, MoreHorizontal, UserPlus, AlertCircle, Box } from 'lucide-react';
...
const ProjectIcon = ({ project }: { project: Project }) => {
    ...
    return (
        <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${project.color || 'from-blue-500 to-blue-600'} flex items-center justify-center text-white shadow-lg shadow-blue-500/20`}>
             {project.key === 'VUL' ? (
                 <VulcanIcon size={20} color="white" />
             ) : project.key ? (
...
const Header: React.FC<HeaderProps> = ({ 
  ...
  const tabs = ['Overview', 'Sprints', 'Tasks', 'Boards', 'Timeline', 'Calendar', 'Teams', 'Files'];
        ...
        <div className="flex items-center gap-4">
             ...
             <div>
                 ...
                 <div className="flex items-center gap-1 text-sm text-gray-500 dark:text-gray-400">
                    <span className="hover:underline cursor-pointer">Vulcan</span>
                    <span>/</span>
