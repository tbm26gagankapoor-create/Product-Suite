                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {userProjects.map(project => (
                                <div key={project.id} className="bg-white dark:bg-[#15171E] border border-gray-200 dark:border-[#1F2128] p-4 rounded-xl flex items-center gap-4">
                                    <div className={`w-10 h-10 rounded-lg bg-gradient-to-br ${project.color} flex items-center justify-center text-gray-900 dark:text-white font-bold`}>{project.key}</div>
                                    <div className="flex-1">
                ...
                <div className="divide-y divide-gray-100 dark:divide-[#1F2128]">
                    {teamProjects.map(project => (
                        <div key={project.id} className="p-4 flex items-center gap-4 hover:bg-gray-50 dark:hover:bg-[#1F2128]/50 transition-colors">
                            <div className={`w-10 h-10 rounded-lg bg-gradient-to-br ${project.color} flex items-center justify-center text-gray-900 dark:text-white font-bold text-xs`}>{project.key}</div>
                            <div className="flex-1">
