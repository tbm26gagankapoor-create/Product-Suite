...
const ProjectList: React.FC<ProjectListProps> = ({ onProjectSelect }) => {
  ...
  const handleCreateProduct = async (productData: any) => {
      ...
      const newProject: Project = {
          ...
          status: 'Planning',
          progress: 0,
          members: [productData.ownerId, ...productData.team],
      ...
      if (productData.epics && Array.isArray(productData.epics)) {
          for (const epicData of productData.epics) {
              ...
              const newEpic: Task = {
                  ...
                  priority: 'MEDIUM',
                  points: 0,
                  assignee: users.find((u: User) => u.id === productData.ownerId) || users[0],
                  reporter: users.find((u: User) => u.id === productData.ownerId) || users[0],
                  tags: [],
                  commentsCount: 0,
