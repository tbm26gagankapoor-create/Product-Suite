...
const InviteUserModal: React.FC<InviteUserModalProps> = ({ onClose, onInviteSent }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#1A1A1A] rounded-xl shadow-2xl w-full max-w-md border border-[#2E2E2E] animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
        <div className="flex items-center justify-between p-5 border-b border-[#2E2E2E]">
          ...
          <button
            onClick={onClose}
            className="p-2 text-[#6B7280] hover:text-white hover:bg-[#252525] rounded-lg transition-colors"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div>
            ...
            <div className="relative group">
              <Mail className="absolute left-3 top-1/2 -translate-y-1/2 text-[#6B7280] group-focus-within:text-[#3B82F6] transition-colors" size={16} />
              <input
                type="email"
                ...
                className="w-full bg-[#0D0D0D] border border-[#2E2E2E] rounded-lg py-2.5 pl-10 pr-4 text-sm text-white placeholder:text-[#6B7280] focus:outline-none focus:border-[#3B82F6] focus:ring-1 focus:ring-[#3B82F6]/30 transition-all disabled:opacity-50"
              />
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                <div className="flex items-center gap-2 mb-1.5">
                  <Shield size={16} className={role === 'member' ? 'text-[#3B82F6]' : 'text-[#6B7280]'} />
              ...
              >
                <div className="flex items-center gap-2 mb-1.5">
                  <ShieldCheck size={16} className={role === 'admin' ? 'text-[#8B5CF6]' : 'text-[#6B7280]'} />
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    value={inviteLink}
                    readOnly
                    className="flex-1 bg-[#0D0D0D] border border-[#2E2E2E] rounded-lg py-2 px-3 text-xs text-white font-mono"
                  />
                  <button
                    type="button"
                    ...
                    className={`p-2 rounded-lg transition-all ${
                      copied
                        ...
                        : 'bg-[#252525] text-[#9CA3AF] hover:bg-[#2E2E2E] hover:text-white'
                    }`}
          ...
          {!success ? (
            <button
              ...
              className="w-full bg-[#3B82F6] hover:bg-[#2563EB] text-white font-semibold py-2.5 rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
            >
              {isLoading ? (
            ...
            <button
              type="button"
              onClick={handleDone}
              className="w-full bg-[#10B981] hover:bg-[#059669] text-white font-semibold py-2.5 rounded-lg transition-colors flex items-center justify-center gap-2 text-sm"
            >
              <CheckCircle size={16} />
              Done
            </button>
